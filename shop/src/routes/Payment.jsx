...
// }
    ...
    const isError = input === '';
    return (<>        <Center><Heading mt={3} mb={3} size="md">Payment Options</Heading></Center>
  ...
  <TabList w="90%">
    ...
    <Image mr={3} w="20%" src="https://img1a.flixcart.com/www/linchpin/batman-returns/logos/Payments%20Logo%20animation_1.gif"></Image>
        ...
        Wallets</Tab>
    <Tab>    <Image mr={3} w="10%" src="https://img.icons8.com/fluency/344/bank-card-back-side.png"></Image>
      Credit/Debit/ATM Card
       
    </Tab>
    <Tab>
    <Image mr={3} w="10%" src="https://img.icons8.com/color/344/cash-.png"></Image>
    Cash On Delivary</Tab>
  </TabList>
  <TabPanels>
    <TabPanel>
      ...
      >
        ...
        <AlertDescription maxWidth='sm'>
          ...
          <Button colorScheme='blue' mr={3} >
            ...
            <Button bg="orange" color="white" onClick={handleOpn} variant='ghost'>Confirm</Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
        </FormHelperText>
    ...
    <TabPanel>
    <FormControl isRequired w="40%" isInvalid={isError}>
      <FormLabel>Enter a unique id and share the unique id with the Delivary boy </FormLabel>
      <Input
        type='text'
